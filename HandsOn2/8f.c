...
int main(){
    ...
    t.it_value.tv_sec = 2;
    t.it_value.tv_usec = 0;
    if(setitimer(ITIMER_VIRTUAL,&t,0) == -1)
    perror("Error while setting timer");
    __sighandler_t err = signal(SIGVTALRM,handler);
    if(err == SIG_ERR){
...
============================================================================
OUTPUT:
bhavya@bhavya-HP-Envy-x360-2-in-1-Laptop-14-fc0xxx:~/Desktop/HandsOn2$ gcc 8f.c
bhavya@bhavya-HP-Envy-x360-2-in-1-Laptop-14-fc0xxx:~/Desktop/HandsOn2$ ./a.out
Received signal is 26
============================================================================
*/